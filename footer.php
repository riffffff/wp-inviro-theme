            ...
            <div class="footer-content">
                <div class="footer-brand">
                    ...
                    if (has_custom_logo()) {
                        ...
                        // Fallback: text logotype with optional icon from Customizer
                        $footer_icon = get_theme_mod('inviro_footer_logo_icon');
                        ?>
                        <h2 class="footer-logo">
                            <?php if ($footer_icon) : ?>
                                <img class="footer-logo-icon" src="<?php echo esc_url($footer_icon); ?>" alt="INVIRO icon" />
                            <?php endif; ?>
                            INVIRO<sup>™</sup>
                        </h2>
                        <?php
                    ...
                    ?>
                    <p class="footer-description" style="font-size: <?php echo esc_attr(get_theme_mod('inviro_footer_desc_font_size', '0.95')); ?>rem; font-weight: <?php echo esc_attr(get_theme_mod('inviro_footer_desc_font_weight', '400')); ?>; text-align: <?php echo esc_attr(get_theme_mod('inviro_footer_desc_text_align', 'left')); ?>; color: <?php echo esc_attr(get_theme_mod('inviro_footer_desc_color', 'rgba(0, 0, 0, 0.85)')); ?>;">
